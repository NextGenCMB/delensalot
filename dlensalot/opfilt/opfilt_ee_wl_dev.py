...
import numpy as np
from dlensalot.utils_hp import almxfl, Alm, alm2cl, synalm, default_rng
from dlensalot.utils import clhash, cli, read_map
from dlensalot import  utils_scarf
from dlensalot import remapping
from dlensalot.opfilt import  opfilt_pp, opfilt_base, bmodes_ninv as bni
from scipy.interpolate import UnivariateSpline as spl
from dlensalot.utils import timer
...
class alm_filter_ninv_wl(opfilt_base.scarf_alm_filter_wl):
    def __init__(self, ninv_geom:utils_scarf.Geometry, ninv:list, ffi_ee:remapping.deflection, ffi_eb:remapping.deflection,
    ...
    def _get_gpmap(self, elm_wf:np.ndarray or list, spin:int, q_pbgeom:utils_scarf.pbdGeometry, ffi:remapping.deflection):
