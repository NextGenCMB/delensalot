...
from dlensalot import cachers, utils_hp
from dlensalot.utils_scarf import pbdGeometry, pbounds, scarfjob
...
output_dir = opj(os.path.dirname(os.path.dirname(dlensalot.__file__)), 'outputs')
...
def ss_ds_QE(libdir, parfile, datidx):
    ...
    from dlensalot.utils_hp import almxfl, alm2cl
