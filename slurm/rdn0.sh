...
srun -n 8 -c 32 python /global/homes/l/llegrand/lenscarf/lenscarf/rdn0_cs.py -par cmbs4wide_planckmask_lminsim2_cstMF -datidx ${SLURM_ARRAY_TASK_ID} -tol 4 -itmax 50
