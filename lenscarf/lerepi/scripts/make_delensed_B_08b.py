...
parser.add_argument('-dset', dest='dset', type=str, default='08b', help='Dataset string. Defines which data will be used. First to digits define the DC, followed by a letter which defines the telescope or configuration.')
