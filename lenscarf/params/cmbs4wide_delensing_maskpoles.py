...
ipix_disc = hp.query_disc(nside=nside, vec=vec, radius=np.radians(0.1))
ipix_disc_low = hp.query_disc(nside=nside, vec=-vec, radius=np.radians(0.1))


mask = np.ones(hp.nside2npix(nside))
mask[ipix_disc] = 0
mask[ipix_disc_low] = 0
