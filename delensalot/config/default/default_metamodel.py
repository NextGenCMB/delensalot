...
DL_DEFAULT = {
    ...
    'qerec':{
        ...
        'chain_desc': lambda p2, p5 : [[0, ["diag_cl"], p2, 2048, np.inf, p5, cd_solve.tr_cg, cd_solve.cache_mem()]],
    },
    'itrec': {
        'tasks': ['calc_fields'],
        'itmax': 1,
        ...
        'chain': lambda p2, p5 : [[0, ["diag_cl"], p2, 2048, np.inf, p5, cd_solve.tr_cg, cd_solve.cache_mem()]],
    },
    'noisemodel': {
    ...
    'computing': {
        'OMP_NUM_THREADS': np.max([1, int(psutil.cpu_count())-2]) #2*int(psutil.cpu_count()/psutil.cpu_count(logical=False))
    },
    'obd': {
        'libdir': DNaV,
        'rescale': 1,
