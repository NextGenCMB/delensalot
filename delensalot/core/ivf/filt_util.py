...
class library_ftl:
    ...
    Args:
         ivfs : inverse filtering library instance (e.g. one of those in delensalot.core.ivf.filt_simple).
...
class library_fml:
    def __init__(self, ivfs, lmax, mfilt_t, mfilt_e, mfilt_b):
        ...
        Args:
             ivfs : inverse filtering library instance (e.g. one of those in core.ivf.filt_simple).
             lmax (int) : defines the new healpy alm array shape (identical for temperature and polarization)
