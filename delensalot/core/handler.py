...
class MAP_scheduler:
    ...
    def __init__(self, dm):
        ...
        self.QE_searchs: QE_scheduler = dm.MAP_job_desc["QE_searchs"]
        ...
        self.MAP_searchs: MAP_handler.minimizer = [MAP_handler.minimizer(self.data_source, **self.MAP_searchs_desc, simidx=simidx, QE_searchs=self.QE_searchs) for simidx in self.simidxs]
