...
dlensalot_model = DLENSALOT_Model(
    ...
    analysis = DLENSALOT_Analysis(
        ...
        TEMP_suffix = 'mfda_maskedsky_center',
        Lmin = 1, 
        lm_max_ivf = (3000, 3000),
        lmin_teb = (10, 10, 200),
        zbounds = ('mr_relative', 10.),
        zbounds_len = ('extend', 5.),
        mask = opj(os.environ['SCRATCH'], 'delensalot/generic/sims_cmb_len_lminB200_mfda_maskedsky_center/mask.fits')
    ),
    data = DLENSALOT_Data(
        class_parameters = {
            'lmax': 4096,
    ...
    noisemodel = DLENSALOT_Noisemodel(
        ...
        nlev_t = 1.00,
        nlev_p = np.sqrt(2),
        rhits_normalised = (opj(os.environ['SCRATCH'], 'delensalot/generic/sims_cmb_len_lminB200_mfda_maskedsky_center/mask.fits'), np.inf)
    ),
    ...
    madel = DLENSALOT_Mapdelensing(
        ...
        iterations = [1],
        masks_fn = [opj(os.environ['SCRATCH'], 'delensalot/generic/sims_cmb_len_lminB200_mfda_maskedsky_center/mask.fits')],
        lmax = 1024,
        Cl_fid = 'ffp10',
        libdir_it = None,
        binning = 'binned',
