"""Iterative reconstruction for s08b fg 00 / 07, using Caterina ILC maps
...
from lerepi.data.dc08 import data_08b as sims_if
from lerepi.survey_config.dc08 import sc_08b as survey_config


qe_key = 'p_p'
fg = '00'
#TODO remove itercurv
TEMP_OBD =  '/global/cscratch1/sd/sebibel/cmbs4/s08b/cILC_%s_OBDsmooth/'%fg
TEMP_noOBD =  '/global/cscratch1/sd/sebibel/cmbs4/s08b/cILC_%s_noOBD/'%fg
TEMP = TEMP_noOBD
...
if not os.path.exists(ivmap_path):
    rhits = np.nan_to_num(hp.read_map('/project/projectdirs/cmbs4/awg/lowellbb/expt_xx/08b/rhits/n2048.fits')) #TODO this should come from survey_conf
