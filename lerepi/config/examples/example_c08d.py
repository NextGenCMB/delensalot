...
dlensalot_model = DLENSALOT_Model(
    ...
    data = DLENSALOT_Data(
        ...
        TEMP_suffix = 'OBDtest2', 
        fg = '00',
        mask_suffix = None,
        mask_norm = 1.0,
        sims = 'cmbs4/08d/ILC_May2022_rhits',
        mask = 'cmbs4/08d/ILC_May2022_rhits',
        masks = ['cmbs4/08d/ILC_May2022_rhits'],
        nside = 2048,
        BEAM = 2.3,
        lmax_transf = 4000,
        transf = hp.gauss_beam,
        zbounds = ('cmbs4/08d/ILC_May2022_rhits', np.inf),
        zbounds_len = ('cmbs4/08d/ILC_May2022_rhits', 5.),
        pbounds = (0., 2*np.pi),
        isOBD = True,
    ...
    geometry = DLENSALOT_Geometry(
        ...
        ninvjob_qe_geometry = 'healpix_geometry'
    ),
    ...
    map_delensing = DLENSALOT_Mapdelensing(
        ...
        ITMAX = 10,
        fg = '00',
        base_mask = 'cmbs4/08d/ILC_May2022_rhits',
        nlevels = [2., 5.],
        nside = 2048,
        lmax_cl = 2048,
        beam = 2.3,
