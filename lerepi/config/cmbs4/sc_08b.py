...
'''
BMARG_LIBDIR: 
From calculating central patch noise level, see jupyter notebook 'Check_inputdata' @ p/pcmbs4/s08b

'''
BMARG_LIBDIR = os.path.join(DATA_LIBDIR, 'reanalysis/mapphi_intermediate/s08b/')
...
rhits = hp.read_map(os.path.join(DATA_LIBDIR, 'expt_xx/08b/rhits/n2048.fits'))
