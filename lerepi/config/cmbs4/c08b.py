...
dlensalot_model = DLENSALOT_Model(
    ...
    data = DLENSALOT_Data(
        ...
        mask = 'cmbs4/08b/caterinaILC_May12',
        masks = ['cmbs4/08b/caterinaILC_May12'],
        zbounds = ('cmbs4/08b/caterinaILC_May12', np.inf),
        zbounds_len = ('cmbs4/08b/caterinaILC_May12', 5.),
        nside = 2048,
        BEAM = 2.3,
        lmax_transf = 4000,
    ...
    map_delensing = DLENSALOT_Mapdelensing(
        ...
        ITMAX = 10,
        fg = '00',
        base_mask = 'cmbs4/08b/caterinaILC_May12',
        nlevels = [2., 5.],
        nside = 2048,
        lmax_cl = 2048,
        beam = 2.3,
